...
@synthesize possibleColors, colorModel;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [possibleColors objectAtIndex:[indexPath row]];
    return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     */
    [colorModel setColorDbl:(double)[[possibleColors objectAtIndex:[indexPath row]] doubleValue]/255];
    NSLog(@"colorDbl: %F",[colorModel colorDbl]);
